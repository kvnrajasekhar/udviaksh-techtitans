                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          screenTitle: "Splash Page_One One".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.splashPageOneOneScreen),
                        ),
                        _buildScreenTitle(
                        ...
                        _buildScreenTitle(
                          screenTitle: "Log In_Empty".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.logInEmptyScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "Splash Page_One".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.splashPageOneScreen),
                        ),
                        _buildScreenTitle(
